...
<section>
    <div class="container rounded bg-info">
        ...
        <div class="row mt-3 text-center">
            <div class="col">
                <img width="200" src="<?= base_url('assets/Dark_Full_Logo.png'); ?>" alt="">
            </div>
            <div class="col text-secondary mt-2">
                <h5>Go to app settings</h5>
            </div>
            <div class="col">
                <button OnClick="location.href='<?=base_url('/webcontrol');?>'" class="btn btn-primary mb-3">Settings</button>
            </div>
        </div>
        <br>
    </div>
